          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 w-full min-w-0">
            {continueReading.map((item) => (
              <button
                ...
                className="flex flex-col items-start gap-1 rounded-sm border border-border p-4 text-left transition-colors duration-micro hover:bg-surface-raised w-full min-w-0 overflow-hidden"
              >
